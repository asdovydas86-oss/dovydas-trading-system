...
| Field | Value |
|---|---|
| **Commit** | `ec352b7` — production code and tests, on top of `2da08b9`, with this product-docs commit directly on top of it |
