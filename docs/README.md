...
| [reviews/CHOCH_FOUNDATION_V1_REVIEW.md](reviews/CHOCH_FOUNDATION_V1_REVIEW.md) | Independent review of Change of Character Foundation v1, re-derived from production code: adversarial cases, 59 mutation probes, measured scaling to 100,000 breaks, and a from-scratch re-derivation of the superseded-sketch finding | Review record — no P0 and no P1 |
