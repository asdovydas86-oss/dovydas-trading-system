...
def test_the_registry_carries_its_commands_in_the_declared_order() -> None:
    ...
    assert names == [
        ...
        # Milestone BV admits "dashboard" as the last of the read surfaces
        # and immediately before "archive", which stays last. The position is
        # the argument: the dashboard is a *window* over every command above
        # it — it computes nothing of its own and adds no step to the
